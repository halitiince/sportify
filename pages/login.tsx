...
const login: FunctionComponent = () => {
    return (
        <div className="h-screen flex flex-col items-center justify-center gradient-deep-space">
            ...
            <button className="bg-white text-camuflage py-4 px-8 rounded-full md:font-bold md:text-xl
